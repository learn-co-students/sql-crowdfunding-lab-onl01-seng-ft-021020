...
def selects_the_user_name_age_and_pledge_amount_for_all_pledges_alphabetized_by_name
  "SELECT user.name, user.age, SUM(user.pledges) FROM projects INNER JOIN pledges ON projects.id = pledges.project_id
    GROUP BY projects.title;"
end

ef selects_the_user_name_age_and_pledge_amount_for_all_pledges
